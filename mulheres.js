...
const cors = require('cors') // aqui estou trazendo o pacote que permite consumir essa api no frontend
...
async function corrigeMulher(request, response) {
    try {
        const mulherEncontrada = await Mulher.findById(request.paramns.id)
